...
- 🎯 **[T5 fine-tune end-to-end recovery](extensions/reports/T5_FT_RECOVERY.md)** — pilot A/B on the 15 known polarity-flips: pass rate **34.8% → 52.2%** (5 recovered, 1 regressed, net +4)
